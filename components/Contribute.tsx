...
const Contribute = () => {
  return (
    <section className='w-full h-screen bg-black flex justify-center items-center' id='About'>
        <div className='w-[70%] h-[50%] bg-white rounded-xl flex justify-around items-center'>
    ...
    <h1 className='text-[32px] text-red w-full whitespace-nowrap'>Blaster </h1>
    <h1 className='text-[32px] w-full whitespace-nowrap'>for the games community </h1>
    <h1 className='text-[32px] w-full whitespace-nowrap'>the OGs who want to contribute </h1>
