...
const Hero = () => {
  return (
    ...
    <div className='w-[80%] h-[60%] md:h-[50%] flex flex-col md:flex-row p-5 md:px-10 justify-around items-center md:justify-between md:items-center bg-white rounded-md '>

    <div className='flex flex-col justify-start w-full md:w-1/3 h-fit text-blue font-mono gap-3'>
